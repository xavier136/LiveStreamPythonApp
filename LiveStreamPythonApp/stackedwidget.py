...
"}")
        ...
        self.page_2.setMinimumSize(QtCore.QSize(800, 600))
        self.page_2.setMaximumSize(QtCore.QSize(800, 600))
        ...
        self.gridLayout_2.addItem(spacerItem7, 10, 1, 1, 1)
        ...
        self.cryptoCurrencyLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.maxHoldingUnitOfCryptoCurrencyLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.maxHoldingUnitOfCryptoCurrencyDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.gridLayoutWidget_2)
        ...
        self.volumePerTradeUnitOfCryptoCurrencyLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.volumePerTradeUnitOfCryptoCurrencyDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.gridLayoutWidget_2)
        ...
        self.tradeFrequencyInSecondsLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tradeFrequencyInSecondsSpinBox = QtWidgets.QSpinBox(self.gridLayoutWidget_2)
        ...
        self.saveDataLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.saveDataCheckBox = QtWidgets.QCheckBox(self.gridLayoutWidget_2)
        ...
        self.gridLayout_2.addLayout(self.formLayout_2, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.startButton, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.stopButton, 9, 1, 1, 1)
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.label.setText(_translate("StackedWidget", "Authentification"))
        self.label_2.setText(_translate("StackedWidget", "Please enter your GDAX Details:"))
        ...
        self.label_3.setText(_translate("StackedWidget", "Algorithm Setting Menu"))
        self.label_4.setText(_translate("StackedWidget", "Please detail your strategy\'s parameters:"))
