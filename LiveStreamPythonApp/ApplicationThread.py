...
class ApplicationThread(QThread):
    ...
    def run(self):
        ...
        self.tradingRoutine = TradingRoutine(self.computationRoutine, self.GDAXClient, self.authentificated, 5, 0.5)#Routine that performs all the trading aspect of the application
