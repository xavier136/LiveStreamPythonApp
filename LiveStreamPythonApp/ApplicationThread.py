...
class ApplicationThread(QThread):
    ...
    def run(self):
        ...
        self.tradingRoutine = TradingRoutine(self.computationRoutine, self.GDAXClient, self.authentificated, 1, 0.01)#Routine that performs all the trading aspect of the application
